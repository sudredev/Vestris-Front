        ...
        <div className="flex-1 overflow-y-auto py-6 px-3 space-y-8">
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              {/* LINK DO CATÁLOGO (NOVO) */}
              <Link to="/vacinas" className={getLinkClass("/vacinas")}>
                <Syringe className="h-4 w-4" /> Catálogo de Vacinas
              </Link>

              {/* === NOVO LINK HUB DE VACINAÇÃO === */}
              <Link to="/vacinacao" className={getLinkClass("/vacinacao")}>
                <Syringe className="h-4 w-4" /> Hub de Vacinas
              </Link>
            </div>
          </div>
        </div>
